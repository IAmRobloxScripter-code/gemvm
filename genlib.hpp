...
public:
    ...
    void write_add()
    {
        this->write<uint8_t>(to_uint8(instructions::add));
    };
    void write_sub()
    {
        this->write<uint8_t>(to_uint8(instructions::sub));
    };
    void write_mul()
    {
        this->write<uint8_t>(to_uint8(instructions::mul));
    };
    void write_div()
    {
        this->write<uint8_t>(to_uint8(instructions::div));
    };
    void write_pow()
    {
        this->write<uint8_t>(to_uint8(instructions::pow));
    };
    void write_mod()
    {
    ...
    void write_jmp(const std::string label)
    {
        ...
        this->label_position_cache.push_back(
            label_cache_child{.label_name = label, .position_in_bytecode = bytecode.size() - 1});
    };
    ...
    void write_cmp_eq()
    {
        this->write<uint8_t>(to_uint8(instructions::cmp_eq));
    };
    void write_cmp_neq()
    {
    ...
    void write_cmp_gt()
    {
        this->write<uint8_t>(to_uint8(instructions::cmp_gt));
    };
    void write_cmp_lt()
    {
        this->write<uint8_t>(to_uint8(instructions::cmp_lt));
    };
    void write_cmp_gte()
    {
    ...
    void write_make_function(const std::string label, std::vector<uint8_t> up_values)
    {
    ...
    void write_call()
    {
        this->write<uint8_t>(to_uint8(instructions::call));
    };
    void write_halt()
    {
        this->write<uint8_t>(to_uint8(instructions::halt));
    };
    void write_close()
    {
        this->write<uint8_t>(to_uint8(instructions::close));
    };
    void write_skip()
    {
